...
//               theme === "dark" ? "bg-gray-700 hover:bg-gray-600" : "bg-blue-500 hover:bg-blue-400",
//             )}
//           >
//             HOME
//           </a>
...
//                   theme === "dark" ? "bg-blue-600 peer-checked:bg-blue-300" : "bg-gray-200 peer-checked:bg-blue-600",
//                 )}
//               ></div>
//               <div
//                 className={cn(
